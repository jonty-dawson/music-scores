...
\header {
    work_title = \markup { \concat { "Turning to October" } }
    composer = \markup { \fontsize #-1  "Jonty Dawson" }
    title = \markup { \concat {"Jonty Dawson - " \fromproperty #'header:work_title } }
    left_title = \markup { \fontsize #1 "Guitar" }
...
\include "turning-to-october.ily"
\layout {
    indent = #15
}
